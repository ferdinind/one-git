...
public class ReferHbaseUtils {
    ...
    private static ReferHbaseUtils instance=null;

    public static synchronized ReferHbaseUtils getInstance() {
        if(null==instance){
            instance=new ReferHbaseUtils();
        }
        return instance;
    }
